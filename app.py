...
mysql_password = getenv('MYSQL_PASSWORD', 'Kw@8149365202')
...
app.secret_key = b'8423adef453c5e74518c9c4054fda1931eccfec4158aaed2'  # all the session data is encrypted in the server so we need a secret key to encrypt and decrypt the data

...
insert into Admins(adminID,firstName,lastName,emailID,password,phone) values('admin3','Komal','Waghmore','komal@gmail.com','kw@1234', 8208276468);

UPDATE Admins
SET firstName = 'Komal', lastName = 'Waghmore', emailID= 'koms@123'
WHERE adminID = 'admin1';

UPDATE Admins
SET firstName = 'Chanchal', lastName = 'Wankahde', emailID= 'chans@123'
WHERE adminID = 'admin12';
